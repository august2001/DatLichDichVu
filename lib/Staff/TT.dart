...
class TTHoaDon extends StatefulWidget {
  final HoaDonData hoaDonData;

  const TTHoaDon({super.key, required this.hoaDonData});

  @override
  State<TTHoaDon> createState() => _TTHoaDonState();
}

class _TTHoaDonState extends State<TTHoaDon> {
