...
import 'package:chothuenhancong/User/CTHoaDonKH.dart';
...
class DSHoaDonKH extends StatefulWidget {
  const DSHoaDonKH({super.key});

  @override
  State<DSHoaDonKH> createState() => _DSHoaDonKHState();
}

class _DSHoaDonKHState extends State<DSHoaDonKH> {
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ChiTietHoaDonKH(
