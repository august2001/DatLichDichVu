...
class BangGiaDienTu extends StatefulWidget {
  const BangGiaDienTu({super.key});

  @override
  State<BangGiaDienTu> createState() => _BangGiaDienTuState();
}

class _BangGiaDienTuState extends State<BangGiaDienTu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance.collection('BangGiaDienTu').snapshots(),
