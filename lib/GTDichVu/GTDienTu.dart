...
class GioiThieuDienTu extends StatefulWidget {
  const GioiThieuDienTu({super.key});

  @override
  State<GioiThieuDienTu> createState() => _GioiThieuDienTuState();
}

class _GioiThieuDienTuState extends State<GioiThieuDienTu> {
  @override
