...
class BangGiaOngNuoc extends StatefulWidget {
  const BangGiaOngNuoc({super.key});

  @override
  State<BangGiaOngNuoc> createState() => _BangGiaOngNuocState();
}

class _BangGiaOngNuocState extends State<BangGiaOngNuoc> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance.collection('BangGiaOngNuoc').snapshots(),
